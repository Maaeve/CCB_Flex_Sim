...
"""
nseg=10
def main_cases_13_16(Q35rated,COP35SH_88,COP35SH_54,COP35SH_35,COP35SH_15,V_TES_SH,QlossSH,
    ...
    # - SH flex 2 only uses the BUH if the compressor stops at its maximum temperature
    ...
    #Water density in kg/m³ and heat capacity in J/kg.K for 35°C, 40°C and 55°C
    rho=992.22
    cp=4179.6
    ...
    for i in range(4):
        if i==0:
            ...
            t_Charge_SH88flex2,Pelec_Charge_SH88flex2,T_TES_SH88_flex2=charge_with_BUH_separated(filelocation,case,1,Mod100,Mod90,Mod70,Mod50,Mod30,T35,T45,T55,V_TES_SH,QlossSH,m_SH,T_env,rho,cp,T_SHmin,T_SHmax1,T_SHmax2,timestep,Q30_55,Q50_55,Q70_55,Q90_55,Q100_55,Q100_45,Q100_35,P30_55,P50_55,P70_55,P90_55,P100_55,P100_45,P100_35,PBUH,Mod_min_Comp,Mod_min_BUH)     
            ...
            t_Charge_SH54flex2,Pelec_Charge_SH54flex2,T_TES_SH54_flex2=charge_with_BUH_separated(filelocation,case,1,Mod100,Mod90,Mod70,Mod50,Mod30,T35,T45,T55,V_TES_SH,QlossSH,m_SH,T_env,rho,cp,T_SHmin,T_SHmax1,T_SHmax2,timestep,Q30_55,Q50_55,Q70_55,Q90_55,Q100_55,Q100_45,Q100_35,P30_55,P50_55,P70_55,P90_55,P100_55,P100_45,P100_35,PBUH,Mod_min_Comp,Mod_min_BUH)    
            ...
            t_Charge_SH35flex2,Pelec_Charge_SH35flex2,T_TES_SH35_flex2=charge_with_BUH_separated(filelocation,case,1,Mod100,Mod90,Mod70,Mod50,Mod30,T35,T45,T55,V_TES_SH,QlossSH,m_SH,T_env,rho,cp,T_SHmin,T_SHmax1,T_SHmax2,timestep,Q30_55,Q50_55,Q70_55,Q90_55,Q100_55,Q100_45,Q100_35,P30_55,P50_55,P70_55,P90_55,P100_55,P100_45,P100_35,PBUH,Mod_min_Comp,Mod_min_BUH)    
            ...
            t_Charge_SH15flex2,Pelec_Charge_SH15flex2,T_TES_SH15_flex2=charge_with_BUH_separated(filelocation,case,1,Mod100,Mod90,Mod70,Mod50,Mod30,T35,T45,T55,V_TES_SH,QlossSH,m_SH,T_env,rho,cp,T_SHmin,T_SHmax1,T_SHmax2,timestep,Q30_55,Q50_55,Q70_55,Q90_55,Q100_55,Q100_45,Q100_35,P30_55,P50_55,P70_55,P90_55,P100_55,P100_45,P100_35,PBUH,Mod_min_Comp,Mod_min_BUH)             
